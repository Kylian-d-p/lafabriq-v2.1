...
export default function AdminCard(props: CardProps) {
    ...
    const handleDeleteConfirm = () => {
        ...
        fetch(v.serverUrl + "deleteProduct", { method: "POST", credentials: "include", mode: "cors", headers: { "Content-type": "application/json", "Authorization": "Bearer " + localStorage.getItem("jwt") }, body: JSON.stringify({ "id": props.id }) }).then((res) => {
